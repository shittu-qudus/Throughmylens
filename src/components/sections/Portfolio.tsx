...
const portfolioImages = [
  {
    id: 1,
    url: 'images/graduation/graduation1.jpg',
    category: 'Graduation',
    size: 'large', // 2x2
  },
  {
    id: 2,
    url: 'images/lifestyle/lifestyle4.jpg',
    category: 'Lifestyle',
    size: 'medium', // 1x1
  },
  {
    id: 3,
    url: 'images/maternity/mat1.jpg',
    category: 'Maternity',
    size: 'medium', // 1x1
  },
  {
    id: 4,
   url: 'images/maternity/mat4.jpg',
    category: 'Maternity',
    size: 'tall', // 1x2
  },
  {
    id: 5,
    url: 'images/nights/night2.jpg',
    category: 'Nights',
    size: 'wide', // 2x1
  },
  {
    id: 6,
    url: 'images/eid/eid1.jpg',
    category: 'Eid',
    size: 'medium', // 1x1
  },
  {
    id: 7,
    url: 'images/graduation/graduation2.jpg',
    category: 'Graduation',
    size: 'medium', // 1x1
  },
  {
    id: 8,
      url: 'images/lifestyle/lifestyle5.jpg',
    category: 'Lifestyle',
    size: 'medium', // 1x1
  },
  {
    id: 9,
      url: 'images/lifestyle/lifestyle2.jpg',
    category: 'Lifestyle',
    size: 'medium', // 1x1
  },
];
    ...
    <section id="portfolio" className="py-32 bg-neutral-50">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-4xl text-black-600 md:text-5xl mb-4 tracking-tight">Our Work</h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            A curated collection showcasing moments of elegance, emotion, and artistry
          </p>
        </motion.div>

        {/* Premium Mixed Grid Layout */}
        <div className="grid grid-cols-2 md:grid-cols-4 auto-rows-[280px] gap-4 mb-16">
          ...
          <div className="inline-flex flex-col items-center gap-6 p-12 bg-white rounded-2xl shadow-lg">
            <div>
              ...
              <p className="text-gray-600">
                Explore our complete portfolio of over 500 captured moments
              </p>
            </div>
            <Button
              size="lg"
              className="bg-black text-white hover:bg-black/90 px-12 py-6 text-lg group transition-all hover:scale-105 shadow-xl"
            >
