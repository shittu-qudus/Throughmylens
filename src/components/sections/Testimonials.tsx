...
const testimonials = [
  ...
  },
  {
    ...
    text: 'Working with Faiza was an absolute pleasure. She made our family feel comfortable and the photos turned out beautifully. Highly recommend!',
    rating: 5,
  ...
  },
  {
    ...
    text: 'From start to finish, Faiza was professional, creative, and fun to work with. Our engagement photos exceeded all expectations!',
    rating: 5,
